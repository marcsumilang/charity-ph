                    ...
                    <table class="table table-bordered ml-lg-3 table-order-items">
                        ...
                        <tr v-for="(value,key) in data.data" :key="key">
                            ...
                            <td class="text-center">
                                <router-link :to="$route.path + '/' + value.id +'/edit'" tag="a"
                                             class="text text-primary">Edit
                                </router-link>
                                <!--|-->
                                <!--<a style="cursor: pointer;" @click="remove(value.id)" class="text text-danger"> Delete </a>-->
                            </td>
                            <td>{{value.mail_option.name}}</td>
                            <td>{{value.to}}</td>
                            <td>{{value.from}}</td>
